...
return function(mod)
  ...
  mod.content.pokemon:patch("MAGNEMITE", {dexEntry = { kind =amagnet = "CALAMITA" }})
  ...
  mod.content.pokemon:patch("DEWONG", {dexEntry = { kind = "LEONE MARINO" }})
  ...
  mod.content.pokemon:patch("CLOYSETR", {dexEntry = { kind = "BIVALVE" }})
  ...
  mod.content.pokemon:patch("HITMONLEE", {dexEntry = { kind = "TIRAPUGNI" }}) -- o tiracalci
  mod.content.pokemon:patch("HITMONLEE", {dexEntry = { kind = "TIRACALCI" }})
  mod.content.pokemon:patch("HITMONCHAN", {dexEntry = { kind = "PUNCHING" }})
  ...
  mod.content.pokemon:patch5 = nil -- (mantenere pulito)
